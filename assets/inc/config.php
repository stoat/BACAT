<?php 
	...
	$gallerypath="assets/images"; 		//EX. images or ../gallery/images no trailing slash needed
	$thumbpath="assets/imagethumbs";	//EX.  images or ../gallery/images no trailing slash needed
